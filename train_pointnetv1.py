...
DEFAULT_CONFIG = {
    ...
    "file_pattern": "*.npy",
    "batch_size": 8,
    "learning_rate": 1e-3,      # Slight increase for PointNet
    "epochs": 100,
    "architecture": "PointnetCFD",
    "scaling": 0.25,            # Controls model width (0.25 = Small, 1.0 = Standard)
    "val_split": 0.1,           # 10% validation is usually enough for geometry tasks
